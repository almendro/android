...
if( typeof(AppMobi) == "undefined" || ( typeof(AppMobi) != "undefined" && typeof(AppMobi.device) == "undefined" ) )
{
...
function loadPhoneGap()
{
	...
	{
		AppMobiDevice.registerLibrary("com.phonegap.PhoneGapModule");
	}
}

function orientationChange(evt)
{
	// forward to the phone gap event system
...
PhoneGap.Channel.prototype.fire = function(e) {
    if (this.enabled) {
    	...
    	if(this.type=='onDeviceReady'){
    		PhoneGap.fireEvent('deviceready');
    	}
        return !fail;
    }
    return true;
...
PhoneGap.exec = function(success, fail, service, action, args) {
    try {
        ...
        var r = phonegapProxy.exec(service, action, callbackId, PhoneGap.stringify(args), true);//prompt(PhoneGap.stringify(args), "gap:"+PhoneGap.stringify([service, action, callbackId, true]));
