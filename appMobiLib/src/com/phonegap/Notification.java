...
public class Notification extends Plugin {
	...
	public synchronized void alert(final String message, final String title, final String buttonLabel, final String callbackId) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				...
				AlertDialog.Builder dlg = new AlertDialog.Builder(ctx.getWrappedActivity());
	...
	public synchronized void activityStart(final String title, final String message) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				notification.spinnerDialog = ProgressDialog.show(ctx.getWrappedActivity(), title , message, true, true, 
	...
	public synchronized void progressStart(final String title, final String message) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				notification.progressDialog = new ProgressDialog(ctx.getWrappedActivity());
